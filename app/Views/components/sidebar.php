...
<div id="docs-sidebar"
  ...
  <nav class="hs-accordion-group p-6 w-full max-h-full flex flex-col justify-between flex-wrap"
    ...
    <ul class="space-y-1.5">
      <li>
        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-[16px] text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-900 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
        ...
        <li class="hs-accordion" id="manage-dashboard-accordion">
          <button type="button"
            class="hs-accordion-toggle hs-accordion-active:text-green-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-[16px] text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
          ...
          <ul class="pt-2 ps-2">
            <li>
              <a href="<?= base_url('data-capaian') ?>"
                class="flex items-center gap-x-3.5 py-2 px-2.5 text-[16px] text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Data Capaian
              </a>
            </li>
